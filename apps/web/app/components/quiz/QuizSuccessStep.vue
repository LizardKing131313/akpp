  ...
  <div class="flex min-h-[520px] w-full flex-col items-center justify-center text-center">
    <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#e9f7ee]">
      <svg class="h-10 w-10 text-[#2ea44f]" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <path
          d="M20 12v7a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h7"
          stroke="currentColor"
          stroke-width="2.5"
          stroke-linecap="round"
          stroke-linejoin="round" />
    ...
    <h3 class="text-brand-dark mt-6 text-3xl font-extrabold">Спасибо!</h3>

    <p class="text-brand-dark mt-4 text-xl">Ваши ответы отправлены мастеру.</p>
    <p class="text-brand-dark mt-2 text-xl">
